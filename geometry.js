const Geometry = [
    new Polygon(43, 215,[255,0,0],[ new Vertex(-2, 48),new Vertex(-12, 48),new Vertex(-27, 33),new Vertex(-27, -61),new Vertex(-25, -63),new Vertex(-11, -63),new Vertex(5, -47),new Vertex(36, 16),new Vertex(36, 17),new Vertex(28, 33),new Vertex(17, 38), ], 'flipperramp_l'),
